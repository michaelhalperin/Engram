...
- 🔌 **Works with every MCP client.** One server, five tools (`remember`, `recall`, `confirm`, `update`, `forget`) plus a pinned `engram://profile` resource any tool can load at session start.
